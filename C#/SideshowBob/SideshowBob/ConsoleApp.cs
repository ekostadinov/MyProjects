...
namespace SideshowBob
{
    class ConsoleApp
    {
        static void Main()
        {
            ...
            //LINQ queries
            var collection = AuthorisedDealer.Instance.SelectVehiclesAfterYear(2007);
            Console.WriteLine(collection[0]);

            var anotherCollection = AuthorisedDealer.Instance.SelectVehiclesBelowPrice(40000);
            Console.WriteLine(anotherCollection[0]);
